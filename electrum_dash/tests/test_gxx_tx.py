...
class TestDashSpecTxSerialization(SequentialTestCase):
    ...
    def test_gxx_tx_pro_reg_tx(self):
    ...
    def test_gxx_tx_pro_up_serv_tx(self):
    ...
    def test_gxx_tx_pro_up_reg_tx(self):
    ...
    def test_gxx_tx_pro_up_rev_tx(self):
    ...
    def test_gxx_tx_sub_tx_register(self):
    ...
    def test_gxx_tx_sub_tx_topup(self):
    ...
    def test_gxx_tx_sub_tx_reset_key(self):
    ...
    def test_gxx_tx_sub_tx_close_account(self):
    ...
    def test_gxx_tx_unknown_spec_tx(self):
    ...
    def test_gxx_tx_wrong_spec_tx(self):
